...
static MIRACAST_RTSP_VIDEO_FORMAT miracast_video_format = WFD_VIDEO_FORMAT_AUTO;
...
char *GO_GetPeerIP(char const* mac)
{
    ...
    char* peerIP = (char*)Palloc(ctx->pool, 256);
    memset(peerIP, '\0', 256);
    FILE* fd = NULL;
    //char (*tables)[32] = (char (*)[32])malloc(32*6);
    char (*tables)[32] = (char (*)[32])Palloc(ctx->pool, sizeof(char[32]) * 6);
    ...
    char* line = (char*)Palloc(ctx->pool, 256);
    memset(line, '\0', 256);
    int length = 0;
    bool ignore = true;
    bool end = false;
...
//			ctx->state = INIT;
        ...
        else if(msg.messageId == WFD_CB_EVENT_SETUP_FROM_P2P)
        {
            ...
            if (ctx->mWFDPlayer->Start(ctx->rtsp_url, ctx->isHdcp, ctx->videoFormat) != 0)
            {
...
int Miracast_Init_ex(int isHdcp, const char *videoFormat, const char *p2p_interface)
{
	int ret = 0;
...
{
	static char videoFormat[1000] = {0};
	static char *wfd_vf_str;

	switch(miracast_video_format)
	{
		case WFD_VIDEO_FORMAT_1080P30:
			wfd_vf_str = "38 00 02 02 00019cff 00000000 00000000 00 0000 0000 00 none none"; //max is 1920x1080 p30
			break;

		case WFD_VIDEO_FORMAT_720P60:
			wfd_vf_str = "30 00 02 02 0000007f 00000000 00000000 00 0000 0000 00 none none"; //max is 1280x720 p60
			break;

		case WFD_VIDEO_FORMAT_720P30:
			wfd_vf_str = "28 00 02 02 0000003f 00000000 00000000 00 0000 0000 00 none none"; //max is 1280x720 p30
			break;

		case WFD_VIDEO_FORMAT_720P24:
			wfd_vf_str = "78 00 02 02 0000801f 00000000 00000000 00 0000 0000 00 none none"; //max is 1280x720 p24
			break;

		default:  // include auto
			wfd_vf_str =
				"00 00 02 10 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"02 08 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"02 04 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"02 02 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"02 01 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"01 10 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"01 08 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"01 04 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"01 02 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none, "
				"01 01 0001FFFF 0F3FFFFF 00000FFF 00 0000 0000 13 none none";
			break;
	}
	sprintf(videoFormat, "wfd_video_formats: %s\r\n", wfd_vf_str);

	CDX_LOGD("set videoFormat: %s", videoFormat);
	return Miracast_Init_ex(isHdcp, videoFormat, "p2p0");
}
